...
//	static ArrayList<Literal> pop9;
	...
	public AmazonLanduseLayer(ArrayList<MunicipalityDataItem> muniData, ArrayList<MesoRegion> mesoRegions, String year){
		super();
		this.year = year;
...
//              	 }
           ...
           double totalAcumDeforestation = 0.0;
        	   ...
        	   for(MunicipalityDataItem muniItem :micro.getMuniItems()){
        		   if(year =="2003"){
        			   totalAcumDeforestation += muniItem.getTotalAcum2003()*muniItem.getArea();
        			   totalArea =muniItem.getArea();
        		   }
        		   if(year =="2004"){
        			   totalAcumDeforestation += muniItem.getTotalAcum2004()*muniItem.getArea();
        			   totalArea =muniItem.getArea();
        		   }
        		   if(year =="2005"){
        			   totalAcumDeforestation += muniItem.getTotalAcum2005()*muniItem.getArea();
        			   totalArea =muniItem.getArea();
        		   }
        		   if(year =="2006"){
        			   totalAcumDeforestation += muniItem.getTotalAcum2006()*muniItem.getArea();
        			   totalArea =muniItem.getArea();
        		   }
        		   ...
        		   for(int k=0; k< muniItem.getOverlapArea().size();k++){
        			   if(year == "2002"){
        			   totalPasturePercentage +=muniItem.getPast06().get(k) *muniItem.getOverlapArea().get(k);
        			   totalAgriculturePercentage +=(muniItem.getTempAgr06().get(k) +muniItem.getPermAgr06().get(k)) *muniItem.getOverlapArea().get(k);
        			   totalAcumDeforestation += muniItem.getAcum2002().get(k)*muniItem.getOverlapArea().get(k);
        			   ...
        			   if(year == "2007"){
            			   totalPasturePercentage +=muniItem.getPast06().get(k) *muniItem.getOverlapArea().get(k);
            			   totalAgriculturePercentage +=(muniItem.getTempAgr06().get(k) +muniItem.getPermAgr06().get(k)) *muniItem.getOverlapArea().get(k);
            			   totalAcumDeforestation += muniItem.getAcum2007().get(k)*muniItem.getOverlapArea().get(k);
            			   totalArea+= muniItem.getOverlapArea().get(k);
            			   }
        			   if(year == "2008"){
            			   totalPasturePercentage +=muniItem.getPast06().get(k) *muniItem.getOverlapArea().get(k);
            			   totalAgriculturePercentage +=(muniItem.getTempAgr06().get(k) +muniItem.getPermAgr06().get(k)) *muniItem.getOverlapArea().get(k);
            			   totalAcumDeforestation += muniItem.getAcum2008().get(k)*muniItem.getOverlapArea().get(k);
            			   totalArea+= muniItem.getOverlapArea().get(k);
            			   }
        		   }
 //       		   System.out.println(totalArea); 
          	...
          	for(String str: borderStringArray){
          		String[] splitStr = str.split(",");	
          		borderPositions.add(Position.fromDegrees(Double.parseDouble(splitStr[1]), Double.parseDouble(splitStr[0]), (totalPasturePercentage +totalAgriculturePercentage) *1000000 *totalAcumDeforestation ));
          	}
...
//          	
            pgon2.setAltitudes((totalPasturePercentage +totalAgriculturePercentage) *1000000 *totalAcumDeforestation+1,1000000 *totalAcumDeforestation);
...
//            LatLon.fromDegrees(43.0, -120.0)
     ...
     //   curtain.getAttributes().setOutlineWidth(10);
       // curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis.next();
        addRenderable(exportAnnotation(new Position(posis.next(), 42000.0), "Großbritannien: "+unitedKingdomExport));
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis2.next();
        addRenderable(exportAnnotation(new Position(posis2.next(), 42000.0), "Russland: "+russiaExport));
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis3.next();
        addRenderable(exportAnnotation(new Position(posis3.next(), 42000.0), "Chile: "+chileExport));
       //  attributesPlain.setInteriorOpacity(1);
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis4.next();
        addRenderable(exportAnnotation(new Position(posis4.next(), 42000.0), "Ägypten: "+egyptExport));
       //  attributesPlain.setInteriorOpacity(1);
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis5.next();
        addRenderable(exportAnnotation(new Position(posis5.next(), 42000.0), "Deutschland: "+exportGermany));
       //  attributesPlain.setInteriorOpacity(1);
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis6.next();
        addRenderable(exportAnnotation(new Position(posis6.next(), 42000.0), "USA: "+exportUSA));
       //  attributesPlain.setInteriorOpacity(1);
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
      ...
      //  arcLegend.getAttributes().setDefaults(defaultAttributes2);
       ...
       // legendHeader.getAttributes().
        ...
        ScreenAnnotation legendHeader = new ScreenAnnotation("Abgeholzte Fläche", new Point(920, 225));
      //  legendHeader.getAttributes().setDefaults(defaultAttributes2);
...
public AnnotationLayer generalInformationLayer(){
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
        ...
        ScreenAnnotation factAnnotation = new ScreenAnnotation("", new Point(160, 300));
      ...
      //  backgroundAnnotation.getAttributes().setSize(new Dimension(300, 190));
        ...
        if(year == "2004"){
        	factAnnotation.setText("Die ersten Rinder kamen 1493 mit Columbus nach Südamerika.");
        	statAnnotation.setText("Pará \n Fläche: " +f2.format((int)totalArea) + " km²\n Abgeholzte Fläche: ~"+ f2.format((int)totalDeforestArea) +" km²\n\n Rindfleisch Export Brasiliens: "+ f2.format((int)totalExport) + " Tonnen");
