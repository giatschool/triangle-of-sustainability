...
public class Dgk5Layer extends BasicTiledImageLayer {
	public Dgk5Layer() {
	...
	private static LevelSet makeLevels(URLBuilder urlBuilder) {
		/*
		 * http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/DGK5?VERSION=1.1.0&
		 * REQUEST=GetMap&
		...
		params.setValue(AVKey.DATA_CACHE_NAME, "Earth/NRWDGK5");
		params.setValue(AVKey.SERVICE,
				"http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/DGK5");
