...
public class Nrw500Layer extends BasicTiledImageLayer {
	...
	private static LevelSet makeLevels(URLBuilder urlBuilder) {
		/*
		 * http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/NRW500?REQUEST=GetMap
		 * &VERSION=1.1.0&
		 * LAYERS=Raster:UEK500:UEK500&SRS=EPSG:31466&BBOX=2560000
		 * ,5660000,2574200,5674200&
		 * FORMAT=image/png&WIDTH=200&HEIGHT=200&TRANSPARENT=TRUE&STYLES=
		 */
		AVList params = new AVListImpl();
		params.setValue(AVKey.TILE_WIDTH, 512);
		params.setValue(AVKey.TILE_HEIGHT, 512);
		params.setValue(AVKey.DATA_CACHE_NAME, "Earth/NRW500");
		params.setValue(AVKey.SERVICE,
				"http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/NRW500");
