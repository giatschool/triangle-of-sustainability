...
/**
 * France Raster layers from Geosignal WMS server
 * http://www.geosignal.org/cgi-bin/wmsmap. http://www.geosignal.fr
 * 
...
public class FranceGeosignalLayer extends BasicTiledImageLayer {
	...
	private static LevelSet makeLevels(URLBuilder urlBuilder) {
		...
		params.setValue(AVKey.SECTOR,
				Sector.fromDegrees(41.1632, 51.2918, -6.06258, 10.8783));
	...
	private static final String[] layerNames = { "4000", "4000", "4000",
			"4000", "1000", "1000", "500", "250", "100", "50", "25", "5", "5",
			"5", "5" };

	private static class URLBuilder implements TileUrlBuilder {
		// public URL getURL(Tile tile, String altImageFormat) throws
		// MalformedURLException
		public URL getURL(Tile tile, String string)
				throws MalformedURLException {
			String layerName = tile.getLevel().getDataset()
					+ layerNames[tile.getLevelNumber()] + "K";
