...
//	static ArrayList<Literal> pop9;
	...
	public AmazonPopulationLayer(ArrayList<MunicipalityDataItem> muniData, String year){
		super();
		this.year = year;
...
//         System.out.println("min: "+minDefor +" max: "+maxDefor);
	...
	public AnnotationLayer addAnnotations(){
        ...
        ScreenAnnotation sa = new ScreenAnnotation("Abholzung des Regenwaldes and Bevölkerung in Pará, Brazilien", new Point(900, 1000));
 ...
 //       defaultAttributes2.setBackgroundColor(new Color(0f, 0f, 0f, .5f));
        ...
        ScreenAnnotation legendHeader = new ScreenAnnotation("Abholzung des Regenwaldes in %", new Point(1750, 125));
