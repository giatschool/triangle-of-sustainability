...
//	static ArrayList<Literal> pop9;
	...
	public AmazonDeforestation(ArrayList<MunicipalityDataItem> muniData, String year){
		super();
		this.year = year;
...
//          		}
        //  	pop = muniData.get(i).getPop2002();
          	...
          	for(String str: borderStringArray){
          		...
          		borderPositions.add(Position.fromDegrees(Double.parseDouble(splitStr[1]), Double.parseDouble(splitStr[0]), acumDefor *1000000 *(muniData.get(i).getTotalPast06() +muniData.get(i).getTotalPermAgr06()+muniData.get(i).getTotalTempAgr06()) ));
          	}
...
//          //	borderPositions2.addAll(tempBorders);
            ...
            pgon2.setAltitudes( acumDefor * 1000000.0 *(muniData.get(i).getTotalPast06() +muniData.get(i).getTotalPermAgr06()+muniData.get(i).getTotalTempAgr06()), acumDefor *1000000.0 );
           Material brown = new Material(new Color(138,90,43));
...
//            LatLon.fromDegrees(43.0, -120.0)
	...
	public AnnotationLayer addAnnotations(){
        ...
        ScreenAnnotation sa = new ScreenAnnotation("Gesamte- und Jährliche Abholzung des Regenwaldes in Para, Brazilien", new Point(900, 1000));
     ...
     //   sa.getAttributes().setAdjustWidthToText(AVKey.SIZE_FIXED); // use strict dimension width - 200
        ...
        ScreenAnnotation sa2 = new ScreenAnnotation(""+trees, new Point(1750, 60));
