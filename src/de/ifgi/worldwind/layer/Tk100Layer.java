...
public class Tk100Layer extends BasicTiledImageLayer {

	public Tk100Layer() {
		super(makeLevels(new URLBuilder()));
		this.setUseTransparentTextures(true);
		this.setMaxActiveAltitude(30e3);
		this.setMinActiveAltitude(15e3);
	}

	private static LevelSet makeLevels(URLBuilder urlBuilder) {
		/*
		 * http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/TK100?REQUEST=getMap&
		 * VERSION=1.1.0&
		 * SERVICE=WMS&LAYERS=Raster%3ATK100_KMF%3AFarbkombination&
		 * STYLES=&SRS=EPSG
		 * :31466&FORMAT=image/png&BGCOLOR=0xFFFFFF&TRANSPARENT=TRUE&
		 * WIDTH=200&HEIGHT=200&BBOX=2587000,5718000,2589000,5720000
		 */
		AVList params = new AVListImpl();
		params.setValue(AVKey.TILE_WIDTH, 512);
		params.setValue(AVKey.TILE_HEIGHT, 512);
		params.setValue(AVKey.DATA_CACHE_NAME, "Earth/NRWTK100");
		params.setValue(AVKey.SERVICE,
				"http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/TK100");
