...
public class NrwOrthoLayer extends BasicTiledImageLayer {
	public NrwOrthoLayer(){
		super(makeLevels(new URLBuilder()));
        this.setUseTransparentTextures(true);
        this.setMaxActiveAltitude(300e3);
	}
	...
	private static LevelSet makeLevels(URLBuilder urlBuilder)
    {
		...
		/*
		 * http://www.gis2.nrw.de/wmsconnector/wms/luftbild?SERVICE=WMS&VERSION=1.1.0&REQUEST=GetMap&
			LAYERS=Orthophoto+Str.+2,Orthophoto+Str.+3&FORMAT=image%2Fpng&TRANSPARENT=TRUE&HEIGHT=200&WIDTH=200&
			BBOX=2628200,5698800,2628800,5699400&SRS=EPSG%3A31466&STYLES=&VERSION=1.1.0
		 */
        AVList params = new AVListImpl();
	        params.setValue(AVKey.TILE_WIDTH, 512);
	        params.setValue(AVKey.TILE_HEIGHT, 512);
	        params.setValue(AVKey.DATA_CACHE_NAME, "Earth/NRWLUFT");
	        params.setValue(AVKey.SERVICE, "http://www.gis2.nrw.de/wmsconnector/wms/luftbild");
	        params.setValue(AVKey.DATASET_NAME, "Orthophoto+Str.+2,Orthophoto+Str.+3");
