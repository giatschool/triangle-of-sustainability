...
public class NRWOverviewLayer extends BasicTiledImageLayer {
	public NRWOverviewLayer(){
		super(makeLevels(new URLBuilder()));
        this.setUseTransparentTextures(true);
        this.setMaxActiveAltitude(600e3);
        this.setMinActiveAltitude(150e3);
...
//        this.setRetainLevelZeroTiles(true);
    ...
    {
		/*
		 * http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/NRW_Uebersicht?REQUEST=GetMap&VERSION=1.1.0&
			SERVICE=WMS&LAYERS=GEPNRW%3AGEP+Gesamt&SRS=EPSG:31466&
			FORMAT=image/png&BBOX=2538900,5656400,2619500,5797000&WIDTH=200&HEIGHT=200&STYLES=&
		 */
		AVList params = new AVListImpl();
		params.setValue(AVKey.TILE_WIDTH, 512);
		params.setValue(AVKey.TILE_HEIGHT, 512);
		params.setValue(AVKey.DATA_CACHE_NAME, "Earth/NRWUebersicht");
		params.setValue(AVKey.SERVICE, "http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/NRW_Uebersicht");
		params.setValue(AVKey.DATASET_NAME, "Raster:NRW_Uebersicht:NRW");
