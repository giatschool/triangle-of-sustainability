...
//All Rights Reserved.
//*/
//package de.ifgi.worldwind.layer.placename;
//
...
//    {
//        int firstCol = Tile.computeColumn(this.tileDelta.getLongitude(), maskingSector.getMinLongitude());
//        int lastCol = Tile.computeColumn(this.tileDelta.getLongitude(),
//            maskingSector.getMaxLongitude().subtract(this.tileDelta.getLongitude()));
...
//            this.extent = dc.getGlobe().computeBoundingCylinder(this.extentVerticalExaggeration, maskingSector);
//        }
//
//        return extent;    }
//
