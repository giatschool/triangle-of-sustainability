...
//        	 pgon2.setCapAttributes(capAttributesPlain); 
        	...
        	String[] splitStr = muniData.get(i).getCentroid().split(",");	
        	 ...
        	 if(muniData.get(i).getName().equals("Santarém") || muniData.get(i).getName().contains("Belém") || muniData.get(i).getName().contains("Altamira") || i == maxPos){
        	   GlobeAnnotation ga2 = new GlobeAnnotation(muniData.get(i).getName()+"\nAbholzung: "+f2.format(totalAcumDeforestation*100)+"%",Position.fromDegrees(Double.parseDouble(splitStr[1]), Double.parseDouble(splitStr[0]), 1000000/2 *totalAcumDeforestation), Font.decode("Arial-BOLD-12"));
...
//            LatLon.fromDegrees(43.0, -120.0)
     ...
     //   curtain.getAttributes().setOutlineWidth(10);
       // curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis.next();
        addRenderable(exportAnnotation(new Position(posis.next(), 42000.0), "Großbritannien: "+f2.format(unitedKingdomExport)));
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis2.next();
        addRenderable(exportAnnotation(new Position(posis2.next(), 42000.0), "Russland: "+f2.format(russiaExport)));
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis4.next();
        addRenderable(exportAnnotation(new Position(posis4.next(), 42000.0), "Ägypten: "+f2.format(egyptExport)));
       //  attributesPlain.setInteriorOpacity(1);
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis5.next();
        addRenderable(exportAnnotation(new Position(posis5.next(), 42000.0), "Deutschland: "+f2.format(exportGermany)));
       //  attributesPlain.setInteriorOpacity(1);
...
//            LatLon.fromDegrees(43.0, -120.0)
    ...
    //    curtain.setPathType(AVKey.RHUMB_LINE);
        ...
        posis6.next();
        addRenderable(exportAnnotation(new Position(posis6.next(), 42000.0), "USA: "+f2.format(exportUSA)));
       //  attributesPlain.setInteriorOpacity(1);
