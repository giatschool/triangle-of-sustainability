...
public class AmazonSoyCattleLayer extends RenderableLayer {
	...
	public AmazonSoyCattleLayer(ArrayList<MunicipalityDataItem> muniData,
			...
			for (MicroRegion micro : mesoRegions.get(i).getMicoRegions()) {
				...
				for (String str : borderStringArray) {
					...
					borderPositions.add(Position.fromDegrees(
							...
							Double.parseDouble(splitStr[0]), totalCattle
									* 7000.0 / totalArea));
				}
				...
				if (totalSoja > 0) {
					...
					for (String str : borderStringArray) {
						...
						// Double.parseDouble(splitStr[0]), new
						// Double("1000000")));
					...
					//
					pgon2.setAltitudes(1.0 + totalCattle * 7000.0 / totalArea,
							1.0 + totalCattle * 7000.0 / totalArea + totalSoja
									* 20000.0 / totalArea);
	...
	public AnnotationLayer addAnnotations() {
		...
		ScreenAnnotation sa = new ScreenAnnotation(
				"Gesamte- und Jährliche Abholzung des Regenwaldes in Pará, Brazilien",
				new Point(900, 1000));
