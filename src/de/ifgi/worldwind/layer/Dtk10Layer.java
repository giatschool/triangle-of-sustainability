...
public class Dtk10Layer extends BasicTiledImageLayer {
	...
	private static LevelSet makeLevels(URLBuilder urlBuilder) {
		/*
		 * http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/DTK10?REQUEST=getMap&
		 * VERSION=1.1.0& SERVICE=WMS&FORMAT=image%2Fpng&
		 * SRS=EPSG%3A31466&LAYERS
		 * =Raster%3ADTK10%3ADtk10G&STYLES=&BBOX=2516500,5746200
		 * ,2516600,5746500&
		...
		params.setValue(AVKey.SERVICE,
				"http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/DTK10");
