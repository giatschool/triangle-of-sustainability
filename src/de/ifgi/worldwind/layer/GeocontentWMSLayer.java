...
public class GeocontentWMSLayer extends BasicTiledImageLayer {
	...
	private static LevelSet makeLevels(URLBuilder urlBuilder) {
		...
		params.setValue(AVKey.SERVICE,
				"http://217.6.21.197/wms/unimuenster.php?");
		...
		// params.setValue(AVKey.SECTOR, Sector.fromDegrees(49.998341,
		// 52.7729742, 5.672412, 10.1417782));
		params.setValue(AVKey.SECTOR,
				Sector.fromDegrees(46.8526, 55.2102, 5.1713, 15.8287));
		params.setValue(AVKey.TILE_URL_BUILDER, urlBuilder);
		params.setValue(AVKey.EXPIRY_TIME,
				new GregorianCalendar(2007, 7, 6).getTimeInMillis());
