...
public class Tk25opaLayer extends BasicTiledImageLayer {
	...
	private static LevelSet makeLevels(URLBuilder urlBuilder) {
		...
		params.setValue(AVKey.DATA_CACHE_NAME, "Earth/NRWTK25opa");
		params.setValue(AVKey.SERVICE,
				"http://www.geoserver.nrw.de/GeoOgcWms1.3/servlet/TK25");
